...
import { convertRouteToLayoutServiceFormat } from '@sitecore-jss/sitecore-jss-node';
      ...
      main: [
        {
          ...
          fields: {
            title: {
              value: 'Sitecore Experience Platform + JSS + SailsJS',
            },
            text: {
            ...
            logoImage: {
              value: {
                src: '/assets/imgages/sc_logo.png',
                alt: 'Logo'
              },
            },
          }
